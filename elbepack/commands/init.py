...
from elbepack.pkgutils import copy_kinitrd, copy_kinitrdiso, NoKinitrdException, get_project_repo_pkg_list, apt_sources_list, debian_installer_mirror_preseed
...
def run_command( argv ):
    ...
    try:
        copy_kinitrdiso(xml.node("/initvm"), out_path, defs)
